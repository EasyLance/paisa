...
export async function buildApp(options = {}) {
  ...
  await app.register(cors, { origin: (process.env.CORS_ORIGINS ?? 'http://localhost:3000').split(','), credentials: true, methods: ['GET', 'HEAD', 'POST', 'PATCH', 'PUT'] });
